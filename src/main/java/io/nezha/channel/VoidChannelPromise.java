...
import io.nezha.concurrent.AbstractFuture;
...
@UnstableApi
public final class VoidChannelPromise extends AbstractFuture<Object> implements ChannelPromise {
     ...
     *
     * @param channel the {@link IChannel} associated with this future
     */
    public VoidChannelPromise(final IChannel channel, boolean fireException) {
        if (channel == null) {
    ...
    @Override
    public VoidChannelPromise addListener(GenericFutureListener<? extends Future<? super Object>> listener) {
        fail();
        return this;
    }

    @Override
    public VoidChannelPromise addListeners(GenericFutureListener<? extends Future<? super Object>>... listeners) {
        fail();
        return this;
    }

    @Override
    public VoidChannelPromise removeListener(GenericFutureListener<? extends Future<? super Object>> listener) {
        // NOOP
        return this;
    }

    @Override
    public VoidChannelPromise removeListeners(GenericFutureListener<? extends Future<? super Object>>... listeners) {
        // NOOP
        return this;
    }
    ...
    @Override
    public VoidChannelPromise setSuccess(Object result) {
        return this;
    }
