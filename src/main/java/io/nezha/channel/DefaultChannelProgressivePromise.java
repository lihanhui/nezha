...
import io.nezha.concurrent.DefaultProgressivePromise;
 ...
 * {@link IChannel#newProgressivePromise()} to create a new {@link ChannelProgressivePromise} rather than calling the
 * constructor explicitly.
 */
public class DefaultChannelProgressivePromise
        extends DefaultProgressivePromise<Object> implements ChannelProgressivePromise, FlushCheckpoint {
     ...
     */
    public DefaultChannelProgressivePromise(IChannel channel) {
     ...
     *        the {@link IChannel} associated with this future
     */
    public DefaultChannelProgressivePromise(IChannel channel, EventExecutor executor) {
        super(executor);
        this.channel = channel;
    }
    ...
    @Override
    public ChannelProgressivePromise setSuccess(Object result) {
    ...
    @Override
    public ChannelProgressivePromise addListener(GenericFutureListener<? extends Future<? super Object>> listener) {
        super.addListener(listener);
        return this;
    }

    @Override
    public ChannelProgressivePromise addListeners(GenericFutureListener<? extends Future<? super Object>>... listeners) {
        super.addListeners(listeners);
        return this;
    }

    @Override
    public ChannelProgressivePromise removeListener(GenericFutureListener<? extends Future<? super Object>> listener) {
