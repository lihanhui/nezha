...
public class DefaultPromise<V> extends AbstractFuture<V> implements Promise<V> {
    ...
    public DefaultPromise(EventExecutor executor) {
        this.executor = io.nezha.internal.ObjectUtil.checkNotNull(executor, "executor");
    }
    ...
    public Promise<V> addListener(GenericFutureListener<? extends Future<? super V>> listener) {
    		io.nezha.internal.ObjectUtil.checkNotNull(listener, "listener");
    ...
    public Promise<V> addListeners(GenericFutureListener<? extends Future<? super V>>... listeners) {
    		io.nezha.internal.ObjectUtil.checkNotNull(listeners, "listeners");
    ...
    protected StringBuilder toStringBuilder() {
        StringBuilder buf = new StringBuilder(64)
                .append(io.nezha.internal.StringUtil.simpleClassName(this))
                .append('@')
    ...
    protected static void notifyListener(
    		...
    		io.nezha.internal.ObjectUtil.checkNotNull(eventExecutor, "eventExecutor");
    		io.nezha.internal.ObjectUtil.checkNotNull(future, "future");
    		io.nezha.internal.ObjectUtil.checkNotNull(listener, "listener");
    ...
    private void notifyListeners() {
        ...
        if (executor.inEventLoop()) {
            final io.nezha.internal.InternalThreadLocalMap threadLocals = io.nezha.internal.InternalThreadLocalMap.get();
    ...
    private boolean setFailure0(Throwable cause) {
        return setValue0(new CauseHolder(io.nezha.internal.ObjectUtil.checkNotNull(cause, "cause")));
    }
